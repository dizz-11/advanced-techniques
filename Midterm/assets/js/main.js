...
function getQuote() {
  let quoteList = [
    ...
    {
      quote: 'Life values is what happens when you\'re busy making other plans.',
      author: 'John lennon'
    }
  ]
  ...
  // let finalQuote = getQuote()
  
  document.getElementById('leftQuote').innerHTML = "&#10077";
  ...
  document.getElementById('rightQuote').innerHTML = "&#10078";
}